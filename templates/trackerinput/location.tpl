<div class="map-container" data-geo-center="{defaultmapcenter}" data-target-field="{$field.ins_id}" data-map-controls="controls,search_location,current_location,navigation,layers"></div>
