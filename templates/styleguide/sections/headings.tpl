<div class="headings">
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h1">{tr}h1. Bootstrap heading{/tr}</div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h2">{tr}h2. Bootstrap heading{/tr}</div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h3">{tr}h3. Bootstrap heading{/tr}</div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h4">{tr}h4. Bootstrap heading{/tr}</div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h5">{tr}h5. Bootstrap heading{/tr}</div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-9">
            <div class="h6">{tr}h6. Bootstrap heading{/tr}</div>
        </div>
