        ...
        <div class="grid-stack-item-content" style="background-color:${bgColor}; color:${textColor}">
            <div>
                ...
                <div class="d-flex display-5 gap-1 mt-1 justify-content-center">
                    <div data-widget-data-source="${dataSource}" data-widget-type="${widget}">
                        <div class='io-state' data-io-state='pending'></div>
                        <div class='pending-dot' title="` +
            tr(" Waiting for hardware to sync this state") + `></div>
                    </div>
                </div>
            </div>
        </div>
