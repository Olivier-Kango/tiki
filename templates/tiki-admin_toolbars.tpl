...
<div class="toolbars-admin clearfix">
    <form name="toolbars" method="post" class="pb-4" action="tiki-admin_toolbars.php" onsubmit="return saveRows()">
        <div class="adminoptionbox mb-3 row">
            ...
            <div class="col-sm-8">
                <select id="section" name="section" onchange="$(this).closest('form').tikiModal(tr('Loading...')).trigger('submit');" class="form-select">
        ...
        <div class="adminoptionbox mb-3 row">
            ...
            <div class="col-sm-8">
                <input id="comments" name="comments" type="checkbox" class="form-check-input" onchange="$(this).closest('form').tikiModal(tr('Loading...')).trigger('submit');" {if $comments eq 'on'}checked="checked" {/if}>
            </div>
        </div>
        <div class="adminoptionbox mb-3 row">
