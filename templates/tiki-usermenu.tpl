...
<form action="tiki-usermenu.php" method="post">
    ...
    <table class="formcolor">
        ...
        <tr>
            <td>&nbsp;</td>
            <td><input type="submit" class="btn btn-primary" name="save" value="{tr}Save{/tr}"></td>
        </tr>
    </table>
</form>
<h2>{tr}Menus{/tr}</h2>
            ...
            {section name=user loop=$channels}
                <tr>
                    <td class="checkbox-cell">
                        <input type="checkbox" class="form-check-input" aria-label="{tr}Select{/tr}"  name="menu[{$channels[user].menuId}]">
                    </td>
