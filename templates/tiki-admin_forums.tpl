            ...
            {if $channels}
                <div class="text-start tiki-form-group row">
                    ...
                    <div class="col-sm-6 input-group">
                        ...
                        <button type="submit" form='admin_forums' formaction="{bootstrap_modal controller=forum}" class="btn btn-primary" onclick="confirmPopup()">
                            {tr}OK{/tr}
                        </button>
                    </div>
                </div>
...
{if !$ts.ajax}
    ...
    {if !isset($dup_mode) or $dup_mode != 'y'}
        ...
        <form action="tiki-admin_forums.php" method="post">
            {ticket}
            <input type="hidden" name="forumId" value="{$forumId|escape}"> <input type="hidden" name="parentId" value="{$parentId|escape}">
            <fieldset>
            ...
            <fieldset>
                ...
                <fieldset class="tiki-form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="topics_list_reads" id="topics_list_reads" {if $topics_list_reads eq 'y'}checked="checked"{/if}>
