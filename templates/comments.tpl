            ...
            {/if}
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="{$comments_complete_father}#comments" id='editpostform'>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            {if $prefs.feature_wysiwyg eq 'y' and $prefs.wysiwyg_htmltowiki eq 'y' and $prefs.feature_forum_parse eq 'y' and ($prefs.wysiwyg_default eq 'y' or $smarty.request.mode_normal neq 'y')}
                                {$forum_wysiwyg = 'y'}
                            {else}
                                {$forum_wysiwyg = 'n'}
                            {/if}
                            ...
                            {if $user and $prefs.feature_user_watches eq 'y'}
                                <div class="form-check">
                                    <input id="watch_thread" type="checkbox" class="form-check-input" name="watch" value="y"{if $user_watching_topic eq 'y' or $smarty.request.watch eq 'y'} checked="checked"{/if}>
