...
<form enctype="multipart/form-data" method="post" action=" " id="editpageform">
    ...
    <br>
    <div class="mb-3 row" id='show_topline' {if $types.$type.show_topline eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_subtitle' {if $types.$type.show_subtitle eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_linkto' {if $types.$type.show_linkto eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_lang'>
    ...
    {/if}
    <div class="mb-3 row" id='show_author' {if $types.$type.show_author eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='use_ratings' {if $types.$type.use_ratings eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_image_2' {if $types.$type.show_image eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_image_3' {if $types.$type.show_image eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='show_image_caption' {if $types.$type.show_image_caption eq 'y'}style="display:;"{else}style="display:none;"{/if}>
    ...
    <div class="mb-3 row" id='heading_only' {if $types.$type.heading_only eq 'y'}style="display: none;"{/if}>
    ...
    <div class="mb-3 row" id='show_pubdate' {if $types.$type.show_pubdate eq 'y' || $types.$type.show_pre_publ ne 'y'}style="display:;"{else}style="display:none;"{/if}>
