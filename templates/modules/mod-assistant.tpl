{tikimodule error=$module_params.error title=$tpl_module_title name="assistant" flip=$module_params.flip decorations=$module_params.decorations nobox=$module_params.nobox notitle=$module_params.notitle}
    ...
    <p>
        {icon name='arrow-right' istyle='border:0;margin-right:2px;vertical-align:middle' align="left"}
    ...
    {else}
    <p>
        <a href="tiki-login.php" title="{tr}Login{/tr}">{icon name='check-circle' alt="{tr}Login{/tr}" istyle='border:0;margin-right:2px;vertical-align:middle' align="left"}</a>{tr}To begin configuring Tiki, please{/tr} <a href="tiki-login.php" title="{tr}Login{/tr}">{tr}login{/tr}</a> {tr}as admin{/tr}.
    </p>
    {/if}
    <p>
    ...
    <p>
        <a href="http://doc.tiki.org" title="{tr}Tiki Documentation{/tr}" target="_blank">{icon name='help' alt="{tr}Tiki Documentation{/tr}" istyle='border:0px;margin-right:2px;vertical-align:middle' align='left'}</a>{tr _0='<a href="http://doc.tiki.org" title="Tiki Documentation" target="_blank">http://doc.tiki.org</a>'}For help, visit %0{/tr}.
    </p>
{/tikimodule}
