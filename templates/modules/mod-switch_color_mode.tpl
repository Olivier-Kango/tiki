...
<div class="bd-navbar" style="width: 12rem;">
    <div class="dropdown dropdown-menu-end">
        <button class="btn btn-link py-2 px-0 px-lg-2 dropdown-toggle d-flex align-items-center text-primary" id="bd-theme" type="button" aria-expanded="false" data-bs-toggle="dropdown" data-bs-display="static" aria-label="Toggle theme (auto)">
