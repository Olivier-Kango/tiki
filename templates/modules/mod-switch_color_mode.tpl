...
{else}
    <div class="bd-navbar">
        <div class="dropdown">
            <button class="btn btn-link dropdown-toggle py-2 px-0 px-lg-2 d-flex align-items-center loading" id="bd-theme" data-bs-toggle="dropdown" type="button" aria-expanded="false" data-bs-display="static" aria-label="Toggle theme (auto)">
                {icon name=$default_icon}
            </button>
            <ul class="dropdown-menu dropdown-menu-start" aria-labelledby="bd-theme-text" data-bs-popper="static">
