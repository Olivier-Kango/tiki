<div class="form-group row">
    ...
    <a class="btn btn-link" href="{service controller=manager action=virtualmin_create}">{icon name=create} {tr}New Virtualmin Instance{/tr}</a>
    <a class="btn btn-link" href="{service controller=manager action=info}">{icon name=info} {tr}Info{/tr}</a>
    <a class="btn btn-link" href="{service controller=manager action=requirements}">{icon name=check} {tr}Requirements{/tr}</a>
</div>