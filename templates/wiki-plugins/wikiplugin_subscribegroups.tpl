...
{foreach from=$possibleGroups item=gr}
    <tr>
    <td>
    <input name="assign[]" type="checkbox" class="form-check-input" value="{$gr|escape}">
...
<input type="submit" class="btn btn-primary btn-sm" value="{if !empty($subscribe)}{$subscribe|escape}{else}{tr}Subscribe to groups{/tr}{/if}">
</form>{/if}
</div>
