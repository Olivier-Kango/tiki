    ...
    <div class="flex-grow-1 ms-3">
        ...
        <div class="row">
            <div class="col-md-{*6 commented out until second column, below, is used. *}12">
                <div class="row">
                    <div class="col-md-6">
                        <h4> {icon name='bug' alt="{tr}Debug Mode Enabled{/tr}"}{tr}Debug Mode Enabled{/tr}</h4>
                        (<a href="tiki-admin.php?ticket={ticket mode=get}&profile=Debug_Mode_Enabled&show_details_for=Debug_Mode_Enabled&categories%5B%5D={$tikiMajorVersion}.x&repository=http%3a%2f%2fprofiles.tiki.org%2fprofiles&page=profiles&preloadlist=y&list=List#step2" target="_blank">{tr}apply profile now{/tr}</a>)
                        <br/>
                        {tr}Profile <i>Debug_Mode_Enabled</i> will help you detect potential errors and warnings which are hidden otherwise.{/tr}
                        <br/>
                        <a href="https://dev.tiki.org/Recovery" target="tikihelp" class="tikihelp" title="{tr}Debug Mode Enabled:{/tr}
                        {tr}More details:{/tr}
                        <ul>
                    ...
                    <div class="col-md-6">
                        ...
                        <br/>
                        <a href="https://dev.tiki.org/Recovery" target="tikihelp" class="tikihelp" title="{tr}Debug Mode Disabled:{/tr}
                        {tr}More details:{/tr}
                        <ul>
                            <li>{tr}Enables/Disables debugging tools{/tr}</li>
                            <li>{tr}Enables/Disables logging tools{/tr}</li>
