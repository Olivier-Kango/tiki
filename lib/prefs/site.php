...
function prefs_site_list()
{
    ...
    return  [
        ...
        'site_mautic_tracking_image' => [
            'name' => tra('Tracking Image'),
            'help' => 'Mautic-Tracking-Image',
            'dependencies' => 'site_mautic_enable',
            'type' => 'flag',
            'perspective' => false,
            'default' => 'n',
        ],
        'site_mautic_logged_users' => [
            'name' => tra('Logged Users'),
            'help' => 'Mautic-Logged-Users',
            'dependencies' => 'site_mautic_enable',
            'type' => 'flag',
            'perspective' => false,
            'default' => 'n',
