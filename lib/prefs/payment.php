...
function prefs_payment_list()
{
    ...
    return [
        ...
        'payment_cart_product_classid_fieldname' => [
            ...
            'description' => tra('In the products tracker, the name of the field for the product class ID'),
            'type' => 'text',
            'default' => 0,
            'profile_reference' => 'tracker_field',
            'parent' => 'input[name=payment_cart_product_tracker]',
        ...
        'payment_cart_order_tracker' => [
            'name' => tra('Order tracker ID'),
            'description' => tra('ID of the tracker that contains the order - needed for advanced cart features.'),
            'type' => 'text',
            'filter' => 'digits',
            'default' => 0,
            'profile_reference' => 'tracker',
        ...
        'payment_cart_order_date_field' => [
            'name' => tra('Order date field'),
        ...
        'payment_cart_order_total_field' => [
            'name' => tra('Order total field'),
        ...
        'payment_cart_order_invoice_field' => [
            'name' => tra('Order invoice field'),
        ...
        'payment_cart_orderitems_tracker' => [
            ...
            'description' => tra('ID of the tracker that contains the order items - needed for advanced cart features.'),
            'type' => 'text',
            'filter' => 'digits',
            'default' => 0,
            'profile_reference' => 'tracker',
        ...
        'payment_cart_orderitems_order_field' => [
            'name' => tra('Order Item Order field'),
        ...
        'payment_cart_orderitems_product_field' => [
            'name' => tra('Order Item Product field'),
        ...
        'payment_cart_orderitems_price_field' => [
            'name' => tra('Order Item price field'),
        ...
        'payment_cart_orderitems_quantity_field' => [
            'name' => tra('Item quantity field'),
        ...
        'payment_cart_orderitems_user_field' => [
            'name' => tra('Item User field'),
