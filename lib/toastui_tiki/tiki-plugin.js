    ...
    const toHTMLRenderers = {
        tiki(node, { entering })
        {
            ...
            if (matches) {
                ...
                if (pluginName.toLowerCase() == 'code') {
                    ...
                    $.getJSON(
                        ...
                        function (data) {
                            ...
                            $pluginDiv.click(function (e) {
                                // If we are in wiki_plugin code (and only there), and we clicked in the copy button skip popping the plugin form and just copy the target text
                                if (pluginName.toLowerCase() == 'code' && e.target.classList.contains('icon_copy_code')) {
                                    return;
                                }
