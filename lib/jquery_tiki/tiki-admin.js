...
*/
    ...
    if ($('#content-admin1-api').length) {
        const container = $(document).closest('.js-allow-copy');
        $(document).tiki('copy')('.js-allow-copy span.icon', () => container.data('content'), function() {
    ...
    $('#dont-show-toggle-advanced-preffilter-alertbox').click(function () {
    ...
    $('#toggle-unified-admin-panel-btn').change(function () {
    ...
    $('#dont-show-toggle-unified-admin-panel-alertbox').click(function () {
    ...
    const updateVisible = function () {
        ...
        let filters = [];
        const prefs = $('#col1 .adminoptionbox.preference, .admbox').hide();
