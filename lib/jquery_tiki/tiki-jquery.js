...
//                        }
        ...
        case "select2":
            ...
            break;
        case "copy":
            return (getText, onSuccess, onError) => {
                if (ClipboardJS.isSupported()) {
                    const thisElementSelector = $(this).attr('id') ? '#' + $(this).attr('id') : '.' + $(this).attr('class').replace(/ /g, '.');
                    const clipboard = new ClipboardJS(thisElementSelector, {
                        text: getText
                    });
...
$('.icon_copy_code').tiki('copy')(null, function(element) {
    setTimeout(function()
    {
