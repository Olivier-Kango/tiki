 ...
 * @param event_id
 */
function deletecalItem(event_id) {
    $('.footer-modal.show:last .modal-content').tikiModal();
    $(this).confirmationDialog({
        message: tr('Are you sure you want to delete the event ?'),
        success: function () {
            $.post(
