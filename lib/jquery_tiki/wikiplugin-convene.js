                                    ...
                                    if ( convene_date_time < current_time ) {
                                        ...
                                        switch (true) {
                                            ...
                                            case (optionValue < 0):
                                                ...
                                                break;
                                            default:
                                                cl = 'convene-unconfirmed text-secondary';
                                                icon = 'help';
                                        }

                                        $(this)
                                            .parent()
                                            .removeClass('convene-no convene-ok convene-unconfirmed text-success text-danger text-light')
                                            .addClass(cl)
                                            .find(".icon")
                                            .setIcon(icon);
                                        $(this)
                                        ...
                                        let $modalContent = $('<input type="text" class="form-control" value="'+inputDataVote.data("comment")+'" />');
                                        ...
                                        $.openModal({
                                            ...
                                            open: function () {
                                                ...
                                                $this.find(".modal-body").append($modalContent);

                                                $this.find(".btn-primary").off("click").click(function () {
                                                    let comment = $modalContent.find('input:first').val();
                                                    ...
                                                    //$this.modal("hide").removeClass("show");
                                                });

                                                $this.find('input:first').focus().keypress(function (event) {
                                                    if (event.which === 13) {
