...
*/
                ...
                let getColor = function (feature, intent, type) {
                ...
                let getStyleAttribute = function (feature, intent, type, def) {
                    return feature.attributes[intent + "-" + type] ||
                        feature.attributes[type] ||
                        def;
                };

                let defaultStyles = new ol.layer.Vector().getStyleFunction()();
...
*/
                ...
                container.vectors.setStyle(container.styleMap);
...
/*
                ...
                container.styleMap.addUniqueValueRules("default", "intent", {
                    "marker": markerStyle, "vectors": vectorStyle
                });

                container.styleMap.addUniqueValueRules("select", "intent", {
                    "marker": markerStyle, "vectors": vectorStyle
                });

                container.styleMap.addUniqueValueRules("temporary", "intent", {
                    "marker": markerStyle, "vectors": vectorStyle
                });
*/

                // map editing handling
