...
function genPass(w1) {
    ...
    for (let i = 0; i < 8; i++) {
        if (i < 2) {
            passwordArray[i] = lower.charAt(Math.round(Math.random() * (lower.length - 1)));
        } else if (i < 4) {
            passwordArray[i] = upper.charAt(Math.round(Math.random() * (upper.length - 1)));
        } else if (i < 6) {
            passwordArray[i] = num.charAt(Math.round(Math.random() * (num.length - 1)));
        } else {
            passwordArray[i] = other.charAt(Math.round(Math.random() * (other.length - 1)));
        }
    }
