    ...
    */
    ...
    private function get_raw_permissions()
    {
        ...
        $permissions = [
            ...
            //),
            [
                'name' => 'tiki_p_admin_machine_learning',
                'description' => tra('Can setup machine learning models and train them'),
                'level' => 'admin',
                'type' => 'machine learning',
                'admin' => true,
                'prefs' => ['feature_machine_learning'],
                'scope' => 'global',
            ],
            [
            ...
            [
                ...
                'prefs' => [],
                'scope' => 'object',
                'apply_to' => ['wiki', 'trackers', 'forums'],
            ],
            [
                'name' => 'tiki_p_print',
                'description' => tra('Can view the print friendly version'),
                'level' => 'basic',
                'type' => 'tiki',
                'admin' => false,
                'prefs' => [],
