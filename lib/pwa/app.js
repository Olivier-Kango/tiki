        ...
        self.addEventListener('load', () => {
            function handleOnlineStatusChange() {
                ...
                if (navigator.onLine) {
                    ...
                    $.pwaFeedback (onlineFeedback.message, onlineFeedback.type, false, onlineFeedback.title);
                } else {
                    console.warn(offlineFeedback.title);
                    $.pwaFeedback(offlineFeedback.message, offlineFeedback.type, false, offlineFeedback.title);
                }
            }
