...
This is the documentation for subdirectories, with hyperlinks tou their respective README.md for more details.  If there is text here, it to clarify why a directory is NOT moving
...
* **public/**
  ...
  * **themes/**
    ...
    * Longer term, spliting the themes directory in 4 will at least make versionning easier, and things clearer:
      ...
      * public/customisations for behaviours currently in themes/css/ and themes/js/
...
* **temp/**
  ...
  * Shouldn't have to be backed-up.  Any file that cannot be reconstructed by tiki (such as mail queues) should go to private/storage
