...
if ($prefs['feature_wiki_attachments'] == 'y' && $prefs['feature_use_fgal_for_wiki_attachments'] != 'y') {
    if (isset($_REQUEST['removeattach']) && $access->checkCsrf()) {
    ...
    if ($access->checkCsrf() && isset($_REQUEST['attach']) && ( $objectperms->wiki_admin_attachments || $objectperms->wiki_attach_files )) {
...
if ($prefs['feature_user_watches'] == 'y') {
    if ($user && isset($_REQUEST['watch_event']) && ! isset($_REQUEST['watch_group']) && $access->checkCsrf()) {
